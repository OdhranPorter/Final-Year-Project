...
**StudiBro** is a **cross-platform mobile application** developed as a **Final Year Project** for the **BSc (Hons) in Computer Science** at **Atlantic Technological University (ATU)**.
...
- Uses **Google ML Kit** via Flutter for fast, on-device text recognition.
...
StudiBro is a **full-stack mobile application** with a clear separation between the **Flutter client** and the **Django backend API**.
